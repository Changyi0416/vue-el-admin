	...
	<el-form ref="goodsRuleForm" label-width="80px" size="medium">
	    ...
	    <div class="card mb-3" v-for="(item, i) in sku_card" :key="i">
	      ...
	      <div class="card-header d-flex align-items-center">
	        ...
	        <el-input size="medium" placeholder="请选择" style="width: 200px;"
	          ...
	          <el-button slot="append" @click="chooseSkuval(i)"><i class="el-icon-more"></i></el-button>
	        </el-input>
	        ...
	        <div class="ml-auto">
				<!-- 上移 -->
	          <el-button icon="el-icon-top" plain size="mini" :disabled="i === 0"
						@click="moveSkuCard({sign: 'moveUp', i})"></el-button>
						<!-- 下移 -->
	          <el-button icon="el-icon-bottom" plain size="mini" :disabled="sku_card.length === (i+1)" 
						@click="moveSkuCard({sign: 'moveDown', i})"></el-button>
	          <el-button type="text" @click="deleSkuCard(i)">删除</el-button>
	        </div>
	      </div>
			<!-- 卡片身体 -->
	      <div class="card-body">
	  ...
	  <el-form-item label="批量设置">
		...
		<div v-else class="d-flex align-items-center">
			...
			<el-button type="primary" size="mini" @click="batchsetConfirm">设置</el-button>
			<el-button size="mini" @click="batchsetCancel">取消</el-button>
		</div>
	  </el-form-item>
