<template>
  <div>
    <div class="d-flex justify-content-end mb-2">
      <el-date-picker v-model="time" type="monthrange"
        range-separator="至"
        start-placeholder="开始月份"
        end-placeholder="结束月份"
        size="medium" style="width: 400px;">
      </el-date-picker>
      <el-input v-model="code" placeholder="请输入订单编号" size="medium" 
      class="mx-2" style="width: 180px;"></el-input>
      <el-button type="info" size="medium" @click="search">搜索</el-button>
    </div>
    <el-table :data="tableData" style="width: 100%" border>
      <el-table-column type="selection" fixed="left" align="center"></el-table-column>
      <el-table-column label="商品信息" prop="name" align="center"></el-table-column>
      <el-table-column label="商品清单" prop="" align="center"></el-table-column>
      <el-table-column label="订单金额" prop="" align="center"></el-table-column>
      <el-table-column label="收货信息" prop="" align="center"></el-table-column>
